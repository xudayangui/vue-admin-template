	...
	<section class="search-form-wrapper">
		<el-form :inline="true">
			<el-row :gutter="20">
				<el-col :span="20">
					<div class="fl">
						<el-form-item label="" class="pad-r-20">
							<el-input placeholder="请输入" v-model.trim="searchForm.name"></el-input>
						</el-form-item>
						<el-form-item>
				...
				<el-col :span="4" class="text-right">
					<el-button type="primary" round @click="addHandle()">添加</el-button>
				</el-col>
			</el-row>
		</el-form>
	</section>
