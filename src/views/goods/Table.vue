<template>
	<el-table :data="tableData" @selection-change="selectionChangeHandle">
		...
		<template slot-scope="scope">
			<el-button type="text" size="small" class="mar-r-20" @click="editHandle(scope.$index, scope.row)">编辑</el-button>
			<el-button type="text" size="small" class="mar-r-20">
				<router-link :to="{path: '/goods/goodsList/goodsDetail',query: {code: scope.row.code}}">详情</router-link>
			</el-button>
			<el-button type="text" size="small" @click="singleDeleteHandle(scope.$index, scope.row)">删除</el-button>
		</template>
		</el-table-column>
	</el-table>
</template>
